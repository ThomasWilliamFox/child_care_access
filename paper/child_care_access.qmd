...
The goal of this paper's modelling strategy is to investigate the effects that average household income, proportion of racialized population, and proportion of English-speaking households have on the number of children per existing child care space in each of Toronto's 25 wards.

Here we briefly describe the Bayesian analysis model used to investigate... Background details and diagnostics are included in [Appendix -@sec-model-details].

## Model set-up

Define $y_i$ as the number of children per child care space in a ward. Then $\beta_i$ is the average household income in the ward, $\gamma_i$ is the proportion of English speaking households in the ward, and $\theta_i$ is the proportion of the ward's population identifying as racialized.  

\begin{align} 
y_i|\mu_i, \sigma &\sim \mbox{Normal}(\mu_i, \sigma) \\
\mu_i &= \beta_i + \gamma_i + \theta_i \\
...
@fig-plot is a credibility interval plot
